...
M1 = mesh("asset/humanoid_tri.obj", Translation(1.5, 2.5, 0.0) ⊙ Scaling(0.1, 0.1, 0.1) ⊙ Translation(0.0, 0.0, -3.05), MatBox)
M2 = mesh("asset/humanoid_quad.obj", Translation(0.5, 1.5, 0.0) ⊙ Scaling(0.1, 0.1, 0.1) ⊙ Translation(0.0, 0.0, -3.05), MatPara)
